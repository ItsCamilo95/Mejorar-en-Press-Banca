...
function calcular(){
	...
	tabla1.innerText=(pesoNuevo*0.75).toFixed(1)+"Kg";
	tabla2.innerText=(pesoNuevo*0.80).toFixed(1)+"Kg";
	tabla3.innerText=(pesoNuevo*0.85).toFixed(1)+"Kg";
	tabla4.innerText=(pesoNuevo*0.90).toFixed(1)+"Kg";
	tabla5.innerText=(pesoNuevo*0.65).toFixed(1)+"Kg";
	tabla6.innerText=pesoNuevo+"Kg";

	tabla7.innerText=(pesoNuevo*0.60).toFixed(1)+"Kg";
	tabla8.innerText=(pesoNuevo*0.65).toFixed(1)+"Kg";
	tabla9.innerText=(pesoNuevo*0.70).toFixed(1)+"Kg";
	tabla10.innerText=(pesoNuevo*0.70).toFixed(1)+"Kg";
	tabla11.innerText=(pesoNuevo*0.60).toFixed(1)+"Kg";
	tabla12.innerText=(pesoNuevo*0.70).toFixed(1)+"Kg";
